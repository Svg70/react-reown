...
const doSomething = async () => {
  ...
  //await sdk.evm.send(10, '5GgJQ2tETLVqq34oQ8nMUgKzdgyeYTDogYGHEhGq93ztmLg3');
  ...
  const uniqueFungible = await UniqueFungibleFactory(0, signerEth);
  // Правильное использование BigInt для возведения в степень:
